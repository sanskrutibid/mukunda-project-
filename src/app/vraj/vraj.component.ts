...
export class VrajComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.titleService.setTitle('Vraj - Residential Project in Nagpur - Mukunda Infraventures');

    this.metaService.updateTag({
      name: 'description',
      content: 'Find residential plots for sale in Nagpur at Vraj by Mukunda Infraventures. Discover a thoughtfully planned project for building your dream home and securing your future.'
    });
