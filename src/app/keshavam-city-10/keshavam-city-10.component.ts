...
@Component({
  selector: 'app-keshavam-city-10',
  imports: [CommonModule, RouterModule, FormsModule, SafeUrlPipe, FontAwesomeModule],
  templateUrl: './keshavam-city-10.component.html',
  styleUrl: './keshavam-city-10.component.css'
})
export class KeshavamCity10Component implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.titleService.setTitle('Commercial Plots in Nagpur - Keshavam City 10');

    this.metaService.updateTag({
      name: 'description',
      content: 'Explore commercial plots in Nagpur at Keshavam City 10 by Mukunda Infraventures. Discover a strategic property opportunity for business and long-term investment.'
    });
  }
}
