...
export class KarmabhoomiComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.titleService.setTitle('Karmabhumi Nagpur - Premium Plots by Mukunda Infraventures');

    this.metaService.updateTag({
      name: 'description',
      content: 'Discover Karmabhumi in Nagpur by Mukunda Infraventures. Explore thoughtfully planned plots, a promising location, and an ideal opportunity to build your future.'
    });
