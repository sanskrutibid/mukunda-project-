...
export class HomeOfficeComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    this.titleService.setTitle('Real Estate & Property in Nagpur - Mukunda Infraventures');

    this.metaService.updateTag({
      name: 'description',
      content: 'Find residential and commercial properties in Nagpur with Mukunda Infraventures. Explore quality projects, strategic locations, and valuable investment opportunities.'
    });
  }
