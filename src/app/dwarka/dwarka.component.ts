...
@Component({
  selector: 'app-dwarka',
  imports: [CommonModule, RouterModule, FormsModule, SafeUrlPipe, FontAwesomeModule, ReactiveFormsModule],
  templateUrl: './dwarka.component.html',
  styleUrl: './dwarka.component.css'
})
export class DwarkaComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.vimeoUrl = `assets/vedio/Sumthana.mp4`;

    this.titleService.setTitle('Plots for Sale in Nagpur - Dwarka by Mukunda Infraventures');

    this.metaService.updateTag({
      name: 'description',
      content: 'Discover Dwarka by Mukunda Infraventures in Nagpur. Explore residential property opportunities, project highlights and a location suited for your future home.'
    });
  }
}
