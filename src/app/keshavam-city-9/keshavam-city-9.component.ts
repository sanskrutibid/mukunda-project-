...
export class KeshavamCity9Component implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.titleService.setTitle('Plots for Sale in Nagpur - Keshavam City 9');

    this.metaService.updateTag({
      name: 'description',
      content: 'Looking for plots for sale in Nagpur? Explore Keshavam City 9 by Mukunda Infraventures and discover residential property opportunities for your dream home.'
    });
  }
}
